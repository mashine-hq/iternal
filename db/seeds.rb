...
Category.create title: "Аварийный комиссар", logo: File.open(File.join(Rails.root, 'app/assets/images/services/comisar.png'))
Category.create title: "Авто-страхование", logo: File.open(File.join(Rails.root, 'app/assets/images/services/insurance.png'))
