  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin_category as @admin_category" do
        ...
        post :create, {:admin_category => { "title" => "invalid value" }}, valid_session
        assigns(:admin_category).should be_a_new(Admin::Category)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin_category" do
        ...
        Admin::Category.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => category.to_param, :admin_category => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the admin_category as @admin_category" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Admin::Category.any_instance.stub(:save).and_return(false)
        put :update, {:id => category.to_param, :admin_category => { "title" => "invalid value" }}, valid_session
        assigns(:admin_category).should eq(category)
      end
